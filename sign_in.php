...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($stmt->execute()) {
            $message = "<p style='color: green; text-align: center;'>تم تسجيل المستخدم بنجاح!</p>";
            header("Location: analysis.html");
            exit;
        } else {
            $message = "<p style='color: red; text-align: center;'>خطأ في التسجيل! يرجى المحاولة مرة أخرى.</p>";
        }
    }
} catch (PDOException $e) {
    $message = "<p style='color: red; text-align: center;'>خطأ: " . $e->getMessage() . "</p>";
}
?>
